...
Like many physicists, I have been using $\LaTeX$ since the very beginning of my undergrad studies, because it's just that great. The main interests are that the content is dissociated from the form (so you can focus on your writing), it handles your references to articles, sections, figures and citations, and it just makes _very_ nice documents. 
